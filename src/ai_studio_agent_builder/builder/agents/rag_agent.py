...
4. **Сгенерировать system‑prompt для будущего LLM‑приложения**
   ...
   - После подготовки или изменения промпта вызови `update_agent_specification` с целью, аудиторией, входами, инструкциями, ограничениями и ожидаемым результатом.
