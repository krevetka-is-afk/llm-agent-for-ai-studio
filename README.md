...
валидированную `AgentSpecification`, которую можно скачать в JSON. One-prompt
может включать встроенный tool `web_search` для актуальной информации, а
RAG-вариант дополнительно включает созданный vector index и публичный
`knowledge_search`.
